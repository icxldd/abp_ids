...
{
    [DbContext(typeof(IdsMigrationsDbContext))]
    [Migration("20210621084616_setting")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Icxl.Abp.ChurchSetting.Domain.ChurchSetting", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<string>("ChurchSettingName")
                        .IsRequired()
                        .HasMaxLength(64)
                    ...
                    b.ToTable("Test.ChurchSetting");
                });

            modelBuilder.Entity("Icxl.Abp.ChurchSetting.Domain.ChurchSettingNode", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("ChurchSettingId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("ChurchSettingId");

                    b.ToTable("Test.ChurchSettingNode");
                });
            ...
            modelBuilder.Entity("Icxl.Abp.ChurchSetting.Domain.ChurchSettingNode", b =>
                {
                    b.HasOne("Icxl.Abp.ChurchSetting.Domain.ChurchSetting", "ChurchSetting")
                        .WithMany("ChurchSettingNodes")
                        .HasForeignKey("ChurchSettingId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ChurchSetting");
                });
            ...
            modelBuilder.Entity("Icxl.Abp.ChurchSetting.Domain.ChurchSetting", b =>
                {
                    b.Navigation("ChurchSettingNodes");
                });
