...
namespace Icxl.Abp.Ids.Data
{
    ...
    {
        public ILogger<IdsDbMigrationService> Logger { get; set; }

        private readonly IDataSeeder _dataSeeder;
        private readonly IEnumerable<IIdsDbSchemaMigrator> _dbSchemaMigrators;
        private readonly ITenantRepository _tenantRepository;
        private readonly ICurrentTenant _currentTenant;

        public IdsDbMigrationService(
            IDataSeeder dataSeeder,
            IEnumerable<IIdsDbSchemaMigrator> dbSchemaMigrators,
            ...
            ICurrentTenant currentTenant)
        {
            ...
            Logger = NullLogger<IdsDbMigrationService>.Instance;
        }
